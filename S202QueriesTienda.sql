...
SELECT p.codigo AS cod_producto, p.nombre AS nombre_producto, f.codigo AS cod_fabricante, f.nombre AS nombre_fabricante FROM producto p INNER JOIN fabricante f ON f.codigo = p.codigo_fabricante;
...
SELECT p.nombre AS nombre_producto, p.precio, f.nombre AS nombre_fabricante FROM producto p INNER JOIN fabricante f ON f.codigo = p.codigo_fabricante WHERE f.nombre = 'Crucial' AND p.precio > 200;
